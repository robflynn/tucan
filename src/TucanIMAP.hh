...
class TucanIMAP : public TucanEmail
{
	public:
		TucanIMAP(string server);
		virtual ~TucanIMAP() {};
	...
	private:
		...
		void processSuccess(string command);
		void processFailure(string command);
};
